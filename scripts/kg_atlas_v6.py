#!/usr/bin/env python3
"""AtlasCloud KG Worker - via 13号机 host with hk142 exit node"""
import time, json, re, uuid, requests, psycopg2
from psycopg2.extras import RealDictCursor
from requests.adapters import HTTPAdapter
from urllib3.util.retry import Retry

DB = "host=127.0.0.1 port=5432 dbname=session_memory user=postgres password=postgres sslmode=disable gssencmode=disable"
