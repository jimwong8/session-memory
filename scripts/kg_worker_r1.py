#!/usr/bin/env python3
"""KG Worker using DeepSeek-R1 (backup model, separate QPM quota)"""
...
OPENAI_API_KEY = os.environ.get("BACKUP_OPENAI_API_KEY", "sk-305x60hxg7EWxGoqE2DmA5tT9GJqQ9a8eRBfh9PgDPBzC148")  # from backup env
KG_MODEL = "DeepSeek-R1-0528-Qwen3-8B"

client = OpenAI(api_key=OPENAI_API_KEY, base_url=os.environ.get("BACKUP_OPENAI_BASE_URL", "https://api.edgefn.net/v1"), timeout=90)
...
def main():
    ...
    print("=== KG Worker (DeepSeek-R1) ===", flush=True)
