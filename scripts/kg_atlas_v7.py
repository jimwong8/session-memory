#!/usr/bin/env python3
"""AtlasCloud KG Worker - runs on 13号机 host"""
import time, json, re, uuid, requests, psycopg2
from psycopg2.extras import RealDictCursor
from requests.adapters import HTTPAdapter
from urllib3.util.retry import Retry

# Use tailscale IP for DB access
DB = "host=100.77.184.40 port=5432 dbname=session_memory user=postgres password=postgres sslmode=disable gssencmode=disable"
