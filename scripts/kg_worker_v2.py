...
# -*- coding: utf-8 -*-
"""
KG Async Worker - High throughput version with proper async support.
"""
import asyncio
import os
import sys
...
async def main():
    ...
    while True:
        ...
        async with session_factory() as db:
            ...
            if not messages:
                print(f"Batch {batch_num}: No more pending messages!")
                break
            ...
            print(f'Batch {batch_num}: processed={len(messages)} success={batch_success} failed={batch_failed} | Total: processed={processed} success={success} failed={failed}')
